...
\[
\text{A desigualdade } |x| > 3 \text{ significa que a distância de } x \text{ até zero é maior que 3.}
\]
...
\[
\text{Isso ocorre quando } x \text{ está fora do intervalo } [-3, 3], \text{ ou seja, nos extremos da reta real.}
\]
